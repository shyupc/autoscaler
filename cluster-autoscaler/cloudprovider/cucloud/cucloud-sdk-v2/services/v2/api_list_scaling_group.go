...
func (api *ApiClient) ListScalingGroups(groupIds ...string) (*model.ListScalingGroupResponse, error) {
	// create request body
	request := model.ListScalingGroupRequest{
		PageSize: 999,
		GroupIds: strings.Join(groupIds, ","),
	}
	// render uri
	uri := api.RenderUri(listScalingGroupsUri, &request)
	// do request
	...
	// get result
	var r model.ListScalingGroupResponse
