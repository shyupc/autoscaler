...
func (r *DescribeScalingGroupRequest) BodyParam() RequestParam {
	return nil
}

func (r *DescribeScalingGroupRequest) PathParam() RequestParam {
	return util.TransferToMapWithTag(r, tagPath)
}

func (r *DescribeScalingGroupRequest) QueryParam() RequestParam {
	return nil
}
